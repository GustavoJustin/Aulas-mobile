...
export default function Lista02() {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.titulo}>Lista 02 - Gustavo Justin de Paula Francisco</Text>
...
{/* ---------------------------------------------------------------- */}
      ...
      <View style={styles.card}>
        ...
        {tem_promocao && <Text style={styles.texto}>Promoção ativa!
...
{/* ---------------------------------------------------------------- */}
      ...
      <View style={styles.card}>
        <Text style={styles.label}>Exercício 3 - Condicionais com Múltiplos Condições</Text>
        <Text style={styles.texto}>{verificarNota(nota)}</Text>
      </View>
    </ScrollView>
  );
}
